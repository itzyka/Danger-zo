        ...
        <section id="proteccion">
            ...
            <div class="content-grid">
                ...
                <div>
                    ...
                    <h3>Redes Seguras</h3>
                    <p>Abrir enlaces desconocidos o escanear códigos sospechosos puede infectar tu dispositivo con virus o exponer tus datos a hackers. Evita riesgos:</p>
                    <p>🔒 No confíes en mensajes u ofertas sospechosas.<br>
                    🚫 Verifica la fuente antes de interactuar.<br>
                    📲 Protege tu información personal.</p>
                    <p>Un momento de precaución puede evitar graves problemas. ¡Cuida tu seguridad digital!</p>
                </div>
            </div>
        </section>
    </div>
